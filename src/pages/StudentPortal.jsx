...
const StudentPortal = () => {
  ...
  const handleCheckout = () => {
    if (!isAuthenticated) return;
    // Simulate booking
    setBookedOrderId(`WN-${Math.floor(Math.random() * 100000)}`);
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-6 border-t border-slate-200">
                    ...
                    <div className="space-y-2">
                       ...
                       <select className="w-full p-3 rounded-xl bg-white border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            >
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border-2 border-dashed border-slate-200 mb-6 inline-block">
                <div className="w-32 h-32 bg-white p-3 rounded-lg shadow-inner border border-slate-100 relative group overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-emerald-600/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-[8px] font-bold text-emerald-700 bg-white px-1.5 py-0.5 rounded">SECURE</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-left space-y-2 mb-6 text-sm">
                 ...
                 <div className="flex justify-between text-xs">
                   ...
                   <span className="font-bold text-emerald-600">12:30 PM - 01:00 PM</span>
                 </div>
              </div>
